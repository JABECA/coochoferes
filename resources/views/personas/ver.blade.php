...
@section('content')
    <section class="section">
        <div class="section-header">
            <h3 class="page__heading">Datos Propietraio i/o Conductor</h3>
        </div>
                    ...
                    <div class="card">
                        <div class="card-body">                            
                            ...
                            <div class="row">
                                    ...
                                    <div class="col-xs-12 col-sm-2 col-md-2">
                                        <div class="form-group">
                                            <label for="apellidos">Apéllidos: {{ $persona->apellidos }}</label>
                                    ...
                                    <div class="col-xs-12 col-sm-2 col-md-2">
                                        <div class="form-group">
                                            <label for="identificacion">Identificacion : {{ $persona->identificacion }}</label>
                                            <!-- <input class="form-control" type="text" name="identificacion"  value="{{ $persona->identificacion }}"> -->
                                        </div>
                                    </div>
                                    <div class="col-xs-12 col-sm-3 col-md-3">
                                        <div class="form-group">
                                            <label for="fecha_expedicion">Fecha de expedicion cedula: {{ $persona->fecha_expedicion }}</label>
