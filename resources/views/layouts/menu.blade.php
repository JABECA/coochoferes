<ul class="sidebar-menu">
    ...
    <?php if (Auth::user()->hasAnyRole('Administrador')): ?>
        ...
        <li class="menu-header">Administraci&oacuten</li>
        ...
        <li class="menu-header">Liquidaci&oacuten Veh&iacuteculos</li>
        ...
        <li class="menu-header">Alistamiento</li>
        ...
        <li class="dropdown"> 
            ...
            <ul class="dropdown-menu" style="display: none;">
                <li>
                    <a class="nav-link" href="/planillas">
                        <i class="fas fa-users"></i><span class="caret">Admin Planillas</span>
                    </a>
                </li>
    ...
    <?php elseif (Auth::user()->hasAnyRole('Conductor')): ?>

     <li class="menu-header">Planillas de Alistamiento</li>
        ...
        <li class="dropdown"> 
            ...
            <ul class="dropdown-menu" style="display: none;">
                <li>
                    <a class="nav-link" href="/planillas/create">
                        <i class="fas fa-users"></i><span class="caret">Crear Planilla</span>
                    </a>
                </li>
            </ul>
        </li>
